...
// Pure core (below) is node-testable; browser bootstrap follows.
(function (root) {
  'use strict';
  ...
  var NAV = [
    ...
    { id: 'replace', file: 'firmware-replacement.html', title: 'The Firmware Replacement', subtitle: 'What TF-A / OP-TEE / U-Boot replace' },
    { id: 'quick',  file: 'quick-start.html', title: 'Quick Start',           subtitle: 'init · sync · build · flash' },
    { id: 'deck',   file: 'kodiak.html',      title: 'Kodiak — Deep Dive',    subtitle: 'Build System Deep Dive' },
    { id: 'followup', file: 'follow-up.html', title: 'Follow-up Platform',    subtitle: 'LeMans (IQ-9075)' },
  ];
